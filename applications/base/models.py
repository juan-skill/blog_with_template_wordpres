...
class Category(ModeloBase):
    ...
    image_referencial = models.ImageField('Image Referencial',upload_to = 'category/')
...
class Author(ModeloBase):
    ...
    image_referencial = models.ImageField('Image Referencial', null = True, blank = True,upload_to = 'authors/')
...
class Post(ModeloBase):
    ...
    image_referencial = models.ImageField('Referencial Image', upload_to = 'images/', max_length = 255)
